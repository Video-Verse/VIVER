...
@AllArgsConstructor
@Table(name="tb_drama")
public class DramaSample extends BaseEntity {
	...
	// 수정시 데이터 처리
    public DramaSample setUpdate(String title, String adult, String originalLanguage, String originalTitle, String overview, String posterPath, String backdropPath, Float voteAverage, Long voteCount, String releaseDate, Float popularity) {
		this.title = title;
		this.adult = adult;
